...
class TabBar extends React.Component {
  ...
  /**
   * get the tabs data from backend
   * @method
   */
  getTabsInfo = () => {
  ...
  /**
   * Handling the tab's data by adding a default click flag and reorder the tabs
   * (by set "Type" tab in the begin, and "State" tab at the end)
   *
   * @method
   * @param  {object[]} data - tabs data
   */
  tabHandler = data => {
    let tabs = [];
  ...
  /**
   * display the content of selected tab
   *
   * @method
   * @param  {object} tab
   */
